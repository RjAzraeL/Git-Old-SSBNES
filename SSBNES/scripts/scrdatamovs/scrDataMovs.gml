function scrDataMov()
{
	...
	/*01*/scrCreateMov("MAR Ground Smash Side" , 18 , true , 110 , 0 , false , true , true , 24 , 30 , .25 , false , false , false , 0);
	/*02*/scrCreateMov("MAR Ground Smash Down" , 8 , true , 110 , 0 , false , true , true , 21 , 30 , .5 , false , false , false , 270);
	/*03*/scrCreateMov("MAR Ground Smash Up", 15 , true , 110 , 0 , false , true , true , 20 , 40 , .25 , false , false , false , 45);
	...
	/*23*/scrCreateMov("POL Aerial Side" , 8 , false , 110 , 0 , false , false , false , 8 , 14 , .25 , false , true , false , false, -1);
